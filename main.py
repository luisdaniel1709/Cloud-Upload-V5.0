...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = 'Bot iniciado correctamente\n\n'
            start_msg+= '🤖Hola!Bienvenido al bot de descargas gratis SuperDownload en su versión inicial 1.0 PlusEdition🌟.\n'
            start_msg+= '🦾Desarrollador: @Luis_Daniel_Diaz\n'
            start_msg+= '🙂Si necesita ayuda o información utilize:\n'
            start_msg+= '/help\n'
            start_msg+= '/about\n'
